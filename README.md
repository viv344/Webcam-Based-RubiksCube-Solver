Project to solve Rubiks cube by inputting scrambled state of thecube via webcam, and uses OpenCV object detection and colour extraction for input of og state.
